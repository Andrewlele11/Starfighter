...
def yellow_hand_movement(keys_pressed, yellow):
...
def red_hand_movement(keys_pressed, red):
...
def main():
    ...
    while run :
        ...
        yellow_hand_movement(keys_pressed, yellow)
        red_hand_movement(keys_pressed, red)
